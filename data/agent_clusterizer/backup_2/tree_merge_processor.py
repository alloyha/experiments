...
class TreeMergeProcessor:
    ...
    async def process_with_priority_queue(
        self,
        dry_assignment_result,
        clusterizer_config: Optional[ClusterizerConfig] = CONFIG_BALANCED_HYBRID,
        max_passes: int = 2,
        prefilter_k: int = 3,
        batch_size: int = 20,
        max_concurrent: int = 5
...
async def example_with_existing_processor():
    ...
    # OPTION 2: Use your existing wave-based method
    ...
    #     batch_size=20,
    #     max_concurrent=5,
    #     enable_dynamic_merging=False  # Use original method
    # )
