...
**Motivo:** UPDATES são muito custosos em Data Lakes (Parquet/Delta). É melhor apenas INSERIR novas versões e resolver a validade na leitura (LEAD/LAG window function).
