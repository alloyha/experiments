...
-- b) Crie uma tabela 'dim_produto_moderna' usando o tipo STRUCT (TYPE composto em PostgreSQL)
--    e ARRAY para representar a mesma categoria.
...
-- a) Tente selecionar todos os produtos da 'dim_produto_moderna' que possuem a
--    categoria 'Informática' (simulando filtro em array).
