...
**c) Benefício:**
Eliminação de **Shuffle** (reparticionamento) de chaves duplicadas. O cliente é processado em um único executor (task Spark) com histórico completo. Isso reduz drasticamente a movimentação de dados entre nós e melhora a performance em ordens de magnitude.
