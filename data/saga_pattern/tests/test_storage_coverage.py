...
# ==============================================
# Tests for sage/storage/redis.py
# ==============================================
    ...
    def test_redis_not_available_import_error(self):
        ...
        with patch.dict('sys.modules', {'redis': None, 'redis.asyncio': None}):
            with patch('sage.storage.redis.REDIS_AVAILABLE', False):
                from sage.storage.redis import RedisSagaStorage, REDIS_AVAILABLE
...
# ==============================================
# Tests for sage/storage/postgresql.py
# ==============================================
    ...
    def test_asyncpg_not_available_import_error(self):
        ...
        with patch.dict('sys.modules', {'asyncpg': None}):
            with patch('sage.storage.postgresql.ASYNCPG_AVAILABLE', False):
                from sage.storage.postgresql import PostgreSQLSagaStorage, ASYNCPG_AVAILABLE
...
class TestPostgreSQLStorageEdgeCases:
    ...
    async def test_postgresql_update_step_not_found(self):
        ...
        from sage.storage.postgresql import ASYNCPG_AVAILABLE
...
# ==============================================
# Tests for sage/storage/memory.py additional edge cases
# ==============================================
