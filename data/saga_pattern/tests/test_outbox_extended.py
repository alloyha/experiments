...
class TestBrokerFactory:
    ...
    def test_get_available_brokers_returns_list(self):
        ...
        from sage.outbox.brokers.factory import get_available_brokers
    ...
    def test_print_available_brokers_output(self, capsys):
        ...
        from sage.outbox.brokers.factory import print_available_brokers
        
        print_available_brokers()
        
        captured = capsys.readouterr()
        assert "Available Brokers" in captured.out
        assert "memory" in captured.out
    
    def test_create_broker_memory(self):
        """Test creating memory broker"""
        from sage.outbox.brokers.factory import create_broker
    ...
    def test_create_broker_kafka_available(self):
        ...
        from sage.outbox.brokers.factory import create_broker, get_available_brokers
        
        if "kafka" not in get_available_brokers():
    ...
    def test_create_broker_rabbitmq_available(self):
        ...
        if "rabbitmq" not in get_available_brokers():
    ...
    def test_create_broker_from_env_memory(self, monkeypatch):
        ...
        from sage.outbox.brokers.factory import create_broker_from_env
        from sage.outbox.brokers.memory import InMemoryBroker
...
class TestSagaStateMachine:
    ...
    async def test_state_machine_with_saga_with_steps(self):
        ...
        from sage.state_machine import SagaStateMachine
    ...
    def test_validate_state_transition_valid(self):
        ...
        from sage.state_machine import validate_state_transition
    ...
    def test_get_valid_next_states(self):
        ...
        from sage.state_machine import get_valid_next_states
...
class TestSagaStepStateMachine:
    ...
    async def test_step_state_machine_initialization(self):
        ...
        from sage.state_machine import SagaStepStateMachine
...
class TestOutboxMemoryStorage:
    ...
    async def test_memory_storage_update_nonexistent_raises(self):
        ...
        from sage.outbox.storage.memory import InMemoryOutboxStorage
        from sage.outbox.storage.base import OutboxStorageError
...
class TestKafkaBrokerMocked:
    ...
    def test_kafka_broker_config_defaults(self):
        ...
        from sage.outbox.brokers.kafka import KafkaBrokerConfig, KAFKA_AVAILABLE
    ...
    def test_kafka_broker_from_env(self, monkeypatch):
        ...
        from sage.outbox.brokers.kafka import KafkaBroker, KAFKA_AVAILABLE
...
class TestRabbitMQBrokerMocked:
    ...
    def test_rabbitmq_broker_config_defaults(self):
        ...
        from sage.outbox.brokers.rabbitmq import RabbitMQBrokerConfig, RABBITMQ_AVAILABLE
    ...
    def test_rabbitmq_broker_from_env(self, monkeypatch):
        ...
        from sage.outbox.brokers.rabbitmq import RabbitMQBroker, RABBITMQ_AVAILABLE
...
class TestCompensationGraph:
    ...
    def test_compensation_graph_empty(self):
        ...
        from sage.compensation_graph import SagaCompensationGraph
    ...
    def test_compensation_graph_single_step(self):
        ...
        from sage.compensation_graph import SagaCompensationGraph, CompensationType
        
        async def compensate(ctx):
            pass
        
        graph = SagaCompensationGraph()
        graph.register_compensation("step1", compensate, compensation_type=CompensationType.MECHANICAL)
...
class TestDeclarativeSaga:
    ...
    async def test_saga_empty_run(self):
        ...
        from sage.decorators import Saga
    ...
    async def test_saga_step_with_no_compensation(self):
        ...
        from sage.decorators import Saga, step
...
class TestOutboxErrors:
    ...
    def test_outbox_publish_error(self):
        ...
        from sage.outbox.types import OutboxEvent, OutboxPublishError
    ...
    def test_outbox_claim_error(self):
        ...
        from sage.outbox.types import OutboxClaimError
