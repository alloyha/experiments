...
from sage.monitoring.logging import (
    SagaLogger, 
    SagaJsonFormatter, 
    SagaContextFilter, 
    setup_saga_logging, 
...
from sage.monitoring.tracing import SagaTracer, trace_saga_action, trace_saga_compensation
from sage.monitoring.metrics import SagaMetrics
from sage.core import Saga, SagaContext
...
class TestSagaLogger:
    ...
    def test_saga_logger_context_injection(self):
        ...
        from sage.monitoring.logging import saga_context
    ...
    def test_setup_saga_logging(self):
        ...
        from sage.monitoring.logging import setup_saga_logging
...
class TestSagaTracer:
    ...
    def test_tracer_record_step_completion(self):
        ...
        # Should not raise exception
        from sage.types import SagaStepStatus
    ...
    def test_tracer_create_child_span(self):
        ...
        span = tracer.create_child_span("external-call", {"service": "payment"})
    ...
    def test_setup_tracing(self):
        ...
        from sage.monitoring.tracing import setup_tracing
...
class TestMonitoringIntegration:
    ...
    async def test_saga_with_monitoring(self):
        ...
        logger = SagaLogger(name="integration-saga")
        tracer = SagaTracer(service_name="integration-test")
        metrics = SagaMetrics()
