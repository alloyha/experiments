...
class TestRedisBrokerConfig:
    ...
    def test_default_values(self):
        ...
        from sage.outbox.brokers.redis import RedisBrokerConfig
...
class TestRedisBrokerConnection:
    ...
    async def test_connect_success(self):
        ...
        from sage.outbox.brokers.redis import RedisBroker, RedisBrokerConfig

        with patch("sage.outbox.brokers.redis.redis") as mock_redis:
    ...
    async def test_connect_failure(self):
        ...
        from sage.outbox.brokers.redis import RedisBroker, RedisBrokerConfig
        from sage.outbox.brokers.base import BrokerConnectionError
...
class TestRedisBrokerPublish:
    ...
    async def test_publish_not_connected_raises(self):
        ...
        from sage.outbox.brokers.redis import RedisBroker, RedisBrokerConfig
        from sage.outbox.brokers.base import BrokerError
    ...
    async def test_publish_failure_raises(self):
        ...
        from sage.outbox.brokers.redis import RedisBroker, RedisBrokerConfig
        from sage.outbox.brokers.base import BrokerPublishError
...
class TestRedisBrokerFactory:
    ...
    def test_create_redis_broker(self):
        ...
        from sage.outbox import create_broker

        with patch("sage.outbox.brokers.redis.REDIS_AVAILABLE", True):
            with patch("sage.outbox.brokers.redis.redis"):
    ...
    def test_redis_in_available_brokers(self):
        ...
        from sage.outbox import get_available_brokers
    ...
    def test_create_redis_raises_when_unavailable(self):
        ...
        with patch("sage.outbox.brokers.redis.REDIS_AVAILABLE", False):
