...
class TestBrokerFactory:
    ...
    def test_create_kafka_raises_when_unavailable(self):
        ...
        with patch.dict("sys.modules", {"aiokafka": None}):
            with patch("sage.outbox.brokers.kafka.KAFKA_AVAILABLE", False):
    ...
    def test_create_rabbitmq_raises_when_unavailable(self):
        ...
        with patch.dict("sys.modules", {"aio_pika": None}):
            with patch("sage.outbox.brokers.rabbitmq.RABBITMQ_AVAILABLE", False):
                with pytest.raises(MissingDependencyError) as exc_info:
...
class TestKafkaBrokerConfig:
    ...
    def test_default_values(self):
        ...
        try:
            from sage.outbox.brokers.kafka import KafkaBrokerConfig
...
class TestRabbitMQBrokerConfig:
    ...
    def test_default_values(self):
        """Test default configuration."""
        try:
            from sage.outbox.brokers.rabbitmq import RabbitMQBrokerConfig
