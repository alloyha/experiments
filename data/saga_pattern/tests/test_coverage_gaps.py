...
from sage.core import Saga, SagaContext, SagaStep, _StepExecutor
from sage.types import SagaStatus, SagaStepStatus, ParallelFailureStrategy, SagaResult
from sage.exceptions import SagaExecutionError, SagaStepError


# ==============================================
# Tests for sage/core.py - _StepExecutor
# ==============================================
...
# ==============================================
# Tests for sage/core.py - Saga duplicate method (lines 254-255, 392-395)
# ==============================================
...
# ==============================================
# Tests for sage/core.py - _build_execution_batches (lines 282-287)
# ==============================================
...
# ==============================================
# Tests for sage/core.py - DAG exception handling (lines 378-390)
# ==============================================
...
# ==============================================
# Tests for sage/core.py - SagaStep __hash__ (line 791)
# ==============================================
...
# ==============================================
# Tests for sage/core.py - Saga already executing (line 413)
# ==============================================
...
# ==============================================
# Tests for sage/monitoring/logging.py - extra record attributes (lines 55, 57, 59)
# ==============================================
...
class TestSagaJsonFormatterExtraAttributes:
    ...
    def test_formatter_with_all_extra_attributes(self):
        ...
        from sage.monitoring.logging import SagaJsonFormatter
        import json
...
# ==============================================
# Tests for sage/monitoring/logging.py - setup_saga_logging (lines 319-323)
# ==============================================
...
class TestSetupSagaLogging:
    ...
    def test_setup_with_no_json_format(self):
        ...
        from sage.monitoring.logging import setup_saga_logging, SagaLogger
...
# ==============================================
# Tests for sage/strategies/wait_all.py (line 37)
# ==============================================
...
# ==============================================
# Tests for sage/strategies/fail_fast_grace.py (line 77)
# ==============================================
...
# ==============================================
# Tests for sage/orchestrator.py (line 64)
# ==============================================
...
# ==============================================
# Tests for sage/state_machine.py (line 23)
# ==============================================
...
class TestStateMachineTypeChecking:
    ...
    def test_state_machine_imports(self):
        ...
        from sage.state_machine import SagaStateMachine, SagaStepStateMachine
        from sage.state_machine import validate_state_transition, get_valid_next_states
...
# ==============================================
# Tests for sage/storage/base.py (line 200->203)
# ==============================================
...
class TestSagaStepStateFromDict:
    ...
    def test_from_dict_without_optional_fields(self):
        ...
        from sage.storage.base import SagaStepState
...
# ==============================================
# Tests for sage/storage/memory.py (lines 133, 167, 179, 184)
# ==============================================
...
# ==============================================
# Tests for sage/metrics.py (line 34->38)
# ==============================================
