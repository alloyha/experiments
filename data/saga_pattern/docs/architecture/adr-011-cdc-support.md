...
### Option 1: Debezium + Kafka Connect (Recommended)
...
### Option 2: Native PostgreSQL Logical Replication
...
async def stream_wal_changes():
    ...
    async with conn.cursor() as cur:
        await cur.execute("START_REPLICATION SLOT sage_cdc ...")
...
- Infrastructure supports Kafka Connect

For now, polling workers are sufficient for most use cases. CDC provides a clear upgrade path when needed.
