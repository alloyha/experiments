...
All notable changes to the Sage Saga Pattern library will be documented in this file.
...
- **NEW:** `sage.outbox.OptimisticPublisher` - 10x latency improvement
...
- **NEW:** `sage.outbox.ConsumerInbox` - Exactly-once processing guarantee
...
#### Exports
- Added to `sage.outbox.__init__.py`:
  - `OptimisticPublisher`
  - `ConsumerInbox`
...
- **TOTAL:** 696 tests (688 passing, 98.9% pass rate)
