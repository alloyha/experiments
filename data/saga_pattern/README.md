# Sage - Production-Ready Saga Pattern for Python
...
[![Chaos Tests](https://img.shields.io/badge/chaos%20tests-12%20passing-green.svg)]()

**Enterprise-grade distributed transaction orchestration with exactly-once semantics.**

> ✅ **96% Test Coverage Achieved** - Exceeding 95% target with 638 passing tests (includes 12 chaos engineering tests)
...
- ✅ **Multiple brokers** - Kafka, RabbitMQ, or in-memory
...
pip install sage-saga[postgresql]

# With Kafka broker
pip install sage-saga[kafka]

# All features
pip install sage-saga[all]
```
...
```python
from sage.outbox import OptimisticPublisher, OutboxWorker
from sage.outbox.storage import PostgreSQLOutboxStorage
from sage.outbox.brokers import KafkaBroker
...
```python
from sage.outbox import ConsumerInbox
...
- ✅ **96% test coverage** (688 passing tests)
