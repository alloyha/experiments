"""
Sage Hooks - Convenience functions for step lifecycle hooks.
...
Example:
    ...
    >>> from sage.hooks import publish_on_success, on_step_enter
    >>> 
...
def publish_on_success(
    storage,
    event_type: str,
    payload_builder: Optional[Callable[[Dict[str, Any], Any], Dict[str, Any]]] = None,
